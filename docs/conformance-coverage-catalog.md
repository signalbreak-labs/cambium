...
| non-alphabetical schema order preservation (I1, goyang defect) | declaration-order-out-of-alphabetical |
...
| `declaration-order-out-of-alphabetical` | ordering-invariants | container with children in NON-alphabetical schema order (the goyang alphabetization defect, I1) | I1-decl-order + serialize-bytes(JsonIetf,Xml); input zebra,a |
