...
func (d Decimal64) String() string {
	return libyang.FormatDecimal64(d.raw, d.fractionDigits, true)
}
...
func (n NodeRef) Name() (string, error) {
	...
	return libyang.PathNodeName(n.path), nil
}
...
func (v UserOrderedView) FindByKey(keys [][2]string) (int, bool, error) {
	...
	// "a" alone). Reject it instead of returning a false positive.
