...
func (g *goEmitter) emitJSONParseHelper(out *strings.Builder) {
	...
	out.WriteString("\t\treturn nil, err\n")
	out.WriteString("\t}\n")
	out.WriteString("\tif _, err := cambiumJSONToken(dec); err == nil {\n")
	...
	out.WriteString("}\n\n")
	out.WriteString("func cambiumJSONToken(dec *json.Decoder) (json.Token, error) {\n")
	out.WriteString("\ttok, err := dec.Token()\n")
	out.WriteString("\tif err != nil {\n")
	out.WriteString("\t\treturn nil, cambiumJSONDecodeErr(err)\n")
	out.WriteString("\t}\n")
	out.WriteString("\treturn tok, nil\n")
	out.WriteString("}\n\n")
	out.WriteString("func cambiumJSONDecodeErr(err error) error {\n")
	out.WriteString("\tif err != nil && strings.Contains(err.Error(), \"exceeded max depth\") {\n")
	out.WriteString("\t\treturn fmt.Errorf(\"JSON_IETF document exceeds maximum nesting depth\")\n")
	out.WriteString("\t}\n")
	...
	out.WriteString("\t}\n")
	out.WriteString("\ttok, err := cambiumJSONToken(dec)\n")
	out.WriteString("\tif err != nil {\n")
	out.WriteString("\t\treturn nil, err\n")
	out.WriteString("\t}\n")
	...
	out.WriteString("\t\t\t\tkeyTok, err := cambiumJSONToken(dec)\n")
	out.WriteString("\t\t\t\tif err != nil {\n")
	out.WriteString("\t\t\t\t\treturn nil, err\n")
	out.WriteString("\t\t\t\t}\n")
	...
	out.WriteString("\t\t\t}\n")
	out.WriteString("\t\t\tend, err := cambiumJSONToken(dec)\n")
	out.WriteString("\t\t\tif err != nil {\n")
	out.WriteString("\t\t\t\treturn nil, err\n")
	out.WriteString("\t\t\t}\n")
